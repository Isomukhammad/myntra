                            ...
                            >
                                <Dialog.Panel className="relative w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-10 text-left align-middle shadow-xl transition-all flex flex-col gap-16">
                                    <div className='flex flex-col items-center'>
                                        <h1 className='text-center font-semibold text-xl'>Восстановление пароля</h1>
                                        <p>Введите свою электронную почту, на которую мы пришлем код восстановления</p>
                                    </div>
                                    <div className='flex flex-col gap-8'>
                                        <div className="relative">
                                            ...
                                            <label htmlFor="phone-number" className="absolute font-medium text-[15px] text-textSecondary duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-1 peer-focus:scale-80 peer-focus:-translate-y-4 left-1">Ваш E-Mail</label>
                                        </div>
                                    </div>
                                    <div className='flex flex-col gap-6 items-center'>
                                        <button className='text-white py-4 rounded-sm font-semibold bg-purpleMain w-full hover:bg-purpleDark transition duration-300'>Оптравить</button>
                                    </div>
